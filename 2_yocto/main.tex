...
\begin{frame}{Distro vs ECL}
    \begin{columns}
        \column{.5\textwidth}
            \centering
            \includegraphics[width=\linewidth,trim={0 1cm 0 2cm},clip]{Creation.jpg}
        \column{.5\textwidth}
            \centering
            \includegraphics[width=\linewidth,trim={0 1cm 0 1.7cm},clip]{Dantes_Inferno.jpg}
    \end{columns}
\end{frame}
...
\begin{frame}{Roles: developer and maintainer}
    \centering
    \includegraphics[width=\linewidth]{Michelangelo_-_The_Creation_of_Adam.jpg}
\end{frame}
